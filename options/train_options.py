...
class TrainOptions(BaseOptions):
    def help(self):
        ...
        options = {
            'DATA': {
                'label_dir_val': 'type: string, help: path to the directory that contains label images for validation',
                'image_dir_val': 'type: string, help: path to the directory that contains photo images for validation',
                },
            ...
            'TRAINING LOSSES AND PROCESS' : {
                ...
                'second_style_slice': 'type:flag, help: loss between one style slice and another',
                ...
                'lambda_vgg': 'type: float, default: 10.0, help: weight for the vgg loss',
                ...
                'mod_disc': 'type: flag, help: Whether Modality-Dataset Discrimination loss is included.',
                'mod_disc_path': 'type: string, default: None, help: Path to modality discriminator network.',
                'mod_disc_epoch': 'type: int, default: 10, help: epoch that is loaded and is in the network file [EPOCH]_net_MD.pth.'
                                  'If mod_disc_path is specified, this is disregarded.',
                ...
                'lambda_mdmod': 'type float, default: 2.5, help: Weight given to modality discrimination loss.',
                'lambda_mddat': 'type: float, default: 1.0, help: Weight given to dataset discrimination loss.',
                ...
                'train_modisc': 'type: boolean, default: False, help:  Whether to make the modality discriminator trainable or not.',
